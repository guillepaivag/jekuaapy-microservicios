...
import { actualizar, crear, obtener, solicitar } from '../controllers/miembrosInternosEquipoControllers.js'
...
// // MIEMBRO_INTERNO-TODO: Solicitar a un usuario que sea miembro de un equipo
// router.get('/aceptar-solicitud/:tokenSolicitud', verificarAceptacionDeSolicitud, aceptarSolicitud)

// Obtener miembro
router.get('/:uidEquipo/:uidMiembro', estaAutenticadoUsuarioServicio, verificarObtencionMiembroInterno, obtener)

// MIEMBRO_INTERNO-TODO: Actualizar miembro del equipo [roles | estado]
