export const baseUrls = {
    ...
    apiMiembro: {
        prod: 'https://southamerica-east1-jekuaa-py.cloudfunctions.net/service_miembro',
        devLocal: 'http://127.0.0.1:7003/jekuaapydev1/southamerica-east1/service_miembro',
        devRemote: 'https://southamerica-east1-jekuaapydev1.cloudfunctions.net/service_miembro',
    },
    apiProyecto: {
        prod: 'https://southamerica-east1-jekuaa-py.cloudfunctions.net/service_proyecto',
        devLocal: 'http://127.0.0.1:7004/jekuaapydev1/southamerica-east1/service_proyecto',
        devRemote: 'https://southamerica-east1-jekuaapydev1.cloudfunctions.net/service_proyecto',
    },
}

export const baseUrlsParams = {
    apiUsuario: '',
    apiCorreo: '',
    apiEquipo: '',
    apiMiembro: '',
